...
--- Marcel Duchamp \footnote{ Nicolas Bourriaud. \emph{Relational Aesthetics.} Le Press du Rel, Paris, France, 2002.}.
\end{quote}
...
American computer programmer Richard Stallman articulated the modern concept of Free Software in 1984 \footnote{ Richard M. Stallman. \emph{Free Software, Free Society: Selected Essays of Richard M. Stallman.} Free Software Foundation, Boston, Massachusetts, USA, 2002.} in an environment of increasing restrictions on the use and production of software. Free Software is not a radical new development, it is a programme of reform intended restore the more freewheeling software development ethic that began to disappear when software became copyrightable in the USA in the late 1970s. 
...
Andy Warhol lost a lawsuit from Patricia Caulfield, the copyright holder of the flower photograph that Warhol used as the source for his 1964  Flowers series \footnote{ McClean, ibid.}. The Warhol Foundation allow use of Warhol's images for the creation of art and non-commercial use, although academics do still pay reproduction fees which seems to go against Warhol's own appropriationist spirit.
...
Artistic freedom is part of the more general category of freedom of speech within an Open Society \footnote{ Karl Popper. \emph{The Open Society And Its Enemies, The Spell of Plato.} Routledge, Oxford, UK, 2002.}. Freedom of speech often becomes ``freedom of expression'' in artistic discussion, although ``freedom of representation'' might be a more useful concept as art more often causes prblems because of what it depicts than how the artist was feeling when creating the depiction. 

Support for freedom of speech involves both opposing censorship and providing support for those who would otherwise struggle to have their voice heard. These are the negative and positive freedoms of speech to use Isaiah Berlin's terms \footnote{ Isaiah Berlin. \emph{Liberty.} Oxford University Press, Oxford, England, UK, 2002.}. They apply equally to art as to the written or spoken word.
...
The current understanding of Free Culture was popularized by lawyer and academic Lawrence Lessig's book of the same name \footnote{ Lawrence Lessig. \emph{Free Culture: How Big Media Uses Technology and the Law to Lock Down Culture and Control Creativity.} The Penguin Press, New York, New York, USA, 2004.}. Lessig founded the organization Creative Commons to address some of the issues he identified \footnote{ See: \url{http://www.creativecommons.org/}}. Their imitation of Free Software's licencing tactic has led to a strong association between alternative licencing and the contemporary idea of Free Culture. 
...
By relying on ever-strengthening copyright law, copyleft might appear to support the very thing it is designed to oppose. But this is not the case. If copyright law disappeared, copyleft would lose its force. Licencing is very popular with the ``Web 2.0'' internet bubble, where it is seen as a source of free labour for web sites and networks. Web 2.0 is an expression of the information knowledge work culture that Harold Liu identifies as opposed to the literary and artistic culture of history \footnote{ Harold Liu. \emph{The Laws of Cool: Knowledge Work and the Culture of Information.} University Of Chicago Press, Chicago, Illinois, US, 2004.}. Both the Web 2.0 and knowledge work objections to licencing can be answered by the fact that is a form of intensification \footnote{ Christine Harold. \emph{OurSpace: Resisting the Corporate Control of Culture.} University Of Minnesota Press, Minneapolis, Minnesota, US, 2007.} or ironisation of copyright law, a judo throw that uses its opponent's own weight against it. 
...
Eric Raymond describes the culture of Open Source as a ``Gift Economy'' \footnote{ Raymond, ibid.}. Again, this is a product of Freedom and cannot be substituted for or sustained without it. The concept of gift economies comes from Marcel Mauss's work in anthropology in the first half of the twentieth century \footnote{ Marcel Mauss. \emph{The Gift - The Form and Reason for Exchange in Archaic Societies.} Routledge, Oxford, England, UK, 2001.}. 
